            ...
            <div className="container mx-auto px-6 relative z-10 flex flex-col gap-4 transition-transform duration-700 ease-out hover:scale-[1.01] cursor-default">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex flex-col items-center md:items-start space-y-2">
                        ...
                        <div className="flex items-center gap-0 transition-transform duration-300 hover:scale-105">
                        ...
                        <p className="text-white/50 text-[9px] font-bold tracking-[0.2em] uppercase transition-all duration-300">
