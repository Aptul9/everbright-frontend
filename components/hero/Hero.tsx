            ...
            <p className="max-w-3xl text-lg md:text-xl text-gray-400 font-medium leading-relaxed">
              {isThai ? (
                <>
                  ...
                  เราเปลี่ยนพลังแห่งการเปลี่ยนแปลงให้เป็นมูลค่าที่แท้จริง
                  กลยุทธ์นวัตกรรมสำหรับบริษัทที่มองไปสู่อนาคต
                </>
              ) : (
                <>
                  In{' '}
                  ...
                  , trasformiamo la potenza del cambiamento in valore reale. Strategie innovative
                  per aziende che guardano al futuro.
                </>
              )}
            </p>
          </div>
