                        ...
                        <Button
                            ...
                            className={`font-bold px-10 h-14 rounded-full text-sm tracking-[0.2em] uppercase transition-all duration-300 active:scale-95 backdrop-blur-md
                                ${touchedButton === 'services'
                                    ...
                                    : 'border-white text-black bg-white hover:border-cyan-400 hover:text-cyan-400 hover:bg-cyan-400/20 hover:shadow-[0_0_25px_rgba(34,211,238,0.3)] hover:scale-105'
                                }`}
                            onClick={(e) => {
                                e.preventDefault();
