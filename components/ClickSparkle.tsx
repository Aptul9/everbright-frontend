        ...
        <div className="fixed inset-0 pointer-events-none z-[9999] overflow-hidden">
            ...
            <style jsx global>{`
                ...
                @keyframes star-rays {
                    ...
                    30% { transform: scaleY(1.2) scaleX(1); opacity: 1; }
                ...
                .animate-star-rays { animation: star-rays 0.4s ease-out forwards; }
                .animate-star-glow { animation: star-glow 0.6s ease-out forwards; }
            `}</style>
        </div>
    );
}
